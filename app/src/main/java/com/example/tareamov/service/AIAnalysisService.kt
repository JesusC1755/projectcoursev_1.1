...
class AIAnalysisService(private val context: Context) {
    ...
    private fun getHostIPs(): List<String> {
        ...
        try {
            ...
            // Agregar IPs estándar primero (alta prioridad) - Modificando el orden para priorizar los más comunes
            // localhost y 127.0.0.1 primero, luego 0.0.0.0 y otros
            val standardIPs = listOf("localhost", "127.0.0.1", "10.0.2.2", "0.0.0.0")
